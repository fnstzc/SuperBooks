...
<form method="POST" action="payer_save.jsp" onsubmit="return check_input(this)">
	<TR>
		<Th colspan=2><div align="center">添加报销人</span></div></th>
	</TR>
	<TR bgcolor="#FFFFFF">
	  <TD width="30%">报销人姓名</TD>
		<TD width="70%">
	  <input TYPE="text" name=name size=20 maxlength=20>&nbsp;**不得超过 10 个汉字</TD>
	</TR>
