...
<body text="#000000">
	...
	<form action="addConsume" method="post" onsubmit="return chk(this)">
		<table cellpadding="2" cellspacing="1" border="0" width="400"
			height="400" class="tableBorder" align=center>
			<tr>
			...
			<tr>
				<td class=forumrow>日期： <input
					onclick="laydate({istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"
					type="button" value="请选择日期" name="time" />
				</td>
			</tr>
			<tr bgcolor=ffffff>
				<td class=forumrow>身份： <select name="identity">
						<option>请选择身份</option>
						<option>爸爸</option>
						<option>妈妈</option>
						<option>儿子</option>
			...
			<tr>
				<td class=forumrow>金额：<input name="cost" type="text" size="10"
					maxlength="10"> (<span class="red">元</span>)
				</td>
			</tr>
			<tr>
				<td class=forumrow>消费地点：<input type="text" name="place" />
				</td>
			</tr>
			<tr>
				<td class=forumrow>消费途径：<input name="costWay" type="text"
					id="project" size="50" maxlength="50">
				</td>
			</tr>
			<tr>
				<td rowspan="2" class=forumrow>具体说明：<textarea name="desc"
						cols="50" rows="8" id="message"></textarea>
				</td>
			</tr>
			<tr>
